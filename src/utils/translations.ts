...
export const translations: Record<Language, RawTranslationSet> = {
  English: {
    ...
    modDocTitle: "Explain My Document",
    modDocBadge: "AI Medical Reader",
    modDocDesc: "Upload a prescription, bill, or medical document and I'll explain it in simple words.",
    modDocAction: "Explain My Document",
  ...
  Hindi: {
    ...
    modDocTitle: "मेरा दस्तावेज़ समझें (Explain My Document)",
    modDocBadge: "AI दस्तावेज़ वाचक",
    modDocDesc: "दवा की पर्ची, बिल या मेडिकल रिपोर्ट अपलोड करें, मैं इसे सरल शब्दों में समझाऊंगा।",
  ...
  Spanish: {
    ...
    modDocTitle: "Explicar mi documento",
    modDocBadge: "Lector Médico IA",
    modDocDesc: "Sube una receta médica, factura o informe clínico y te lo explicaré en palabras sencillas.",
    modDocAction: "Explicar documento",
  ...
  Tamil: {
    ...
    modDocTitle: "என் ஆவணத்தை விளக்கு (Explain My Document)",
    modDocBadge: "AI ஆவண வாசிப்பாளர்",
    modDocDesc: "மருந்துச் சீட்டு, பில் அல்லது மருத்துவ அறிக்கையை பதிவேற்றுங்கள், மிக எளிய தமிழில் விளக்குகிறேன்.",
  ...
  Bengali: {
    ...
    modDocTitle: "আমার নথি বুঝিয়ে দিন (Explain My Document)",
    modDocBadge: "AI নথি পাঠক",
    modDocDesc: "প্রেসক্রিপশন, বিল বা মেডিকেল রিপোর্ট আপলোড করুন, সহজ ভাষায় বুঝিয়ে দেব।",
    modDocAction: "নথি বুঝুন",
  ...
  Telugu: {
    ...
    modDocTitle: "నా పత్రాన్ని వివరించండి (Explain My Document)",
    modDocBadge: "AI పత్ర రీడర్",
    modDocDesc: "మందుల చీటీ, బిల్లు లేదా వైద్య నివేదికను అప్‌లోడ్ చేయండి, సరళమైన మాటల్లో వివరిస్తాను.",
    modDocAction: "పత్రాన్ని వివరించండి",
  ...
  Marathi: {
    ...
    modDocTitle: "माझे कागदपत्र समजून सांगा (Explain My Document)",
    modDocBadge: "AI कागदपत्र वाचक",
    modDocDesc: "औषधांची पावती, बिल किंवा वैद्यकीय रिपोर्ट अपलोड करा, मी सोप्या शब्दांत समजावून सांगेन.",
  ...
  Gujarati: {
    ...
    modDocTitle: "મારો દસ્તાવેજ સમજાવો (Explain My Document)",
    modDocBadge: "AI દસ્તાવેજ વાચક",
    modDocDesc: "દવાઓની કાપલી, બિલ અથવા મેડિકલ રિપોર્ટ અપલોડ કરો, હું સરળ શબ્દોમાં સમજાવીશ.",
    modDocAction: "દસ્તાવેજ સમજો",

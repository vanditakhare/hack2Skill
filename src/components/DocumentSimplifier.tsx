...
export const DocumentSimplifier: React.FC<DocumentSimplifierProps> = ({ profile }) => {
  ...
  return (
    <div id="document-simplifier-module" className="space-y-6">
      ...
      <div className="bg-white rounded-3xl border border-stone-200 p-6 sm:p-8 shadow-xs">
        ...
        <div className="mt-4 pt-4 border-t border-stone-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            {sampleDocuments.map((s) => (
              ...
              >
                <span className="text-xs font-bold text-amber-700 block uppercase mb-0.5">
                  {s.tag}
                </span>
        ...
        <div className="mt-5 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <label className="flex items-center gap-1.5 text-xs font-bold text-amber-800 bg-amber-50 hover:bg-amber-100 px-3 py-1.5 rounded-xl border border-amber-300 cursor-pointer transition">
          ...
          <textarea
            ...
            className="w-full p-4 rounded-2xl border-2 border-stone-200 focus:border-amber-600 focus:outline-none text-base text-stone-800 font-medium leading-relaxed bg-stone-50/50"
          />
          ...
          <div className="flex items-center justify-end">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-amber-700 hover:bg-amber-800 disabled:opacity-40 text-white font-extrabold text-base transition shadow-md active:scale-95 cursor-pointer min-h-[48px]"
            >
              <Sparkles className="w-5 h-5 text-amber-300" />
              <span>{isLoading ? "Reading with Sathi..." : "Explain This Document Simply"}</span>
            </button>
          </div>
        </div>
      </div>
      ...
      {result && (
        <div className="bg-white rounded-3xl border-2 border-amber-300 p-6 sm:p-8 shadow-md space-y-6 animate-fadeIn">
          {/* Top Result Banner */}
          <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-stone-100">
            <div>
              <span className="text-xs font-bold px-3 py-1 rounded-full bg-emerald-100 text-emerald-900 border border-emerald-300">
                Sathi Plain-Language Explanation
              </span>
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-amber-100 hover:bg-amber-200 text-amber-900 font-bold text-sm cursor-pointer shadow-2xs min-h-[44px]"
            >
            ...
            >
              ...
              <p
                className={`text-lg font-black leading-relaxed ${
                  result.isUrgent ? "text-amber-900" : "text-emerald-900"
                }`}
              >
          ...
          <div className="p-5 rounded-2xl bg-amber-50/60 border border-amber-200">
            <h4 className="font-extrabold text-base text-amber-950 mb-3 flex items-center gap-2">
          ...
          <div className="p-4 rounded-2xl bg-stone-100 border border-stone-200 flex items-start gap-3">
            ...
            <div>
              <h5 className="font-bold text-sm text-stone-900">Sathi Reassurance Note:</h5>
